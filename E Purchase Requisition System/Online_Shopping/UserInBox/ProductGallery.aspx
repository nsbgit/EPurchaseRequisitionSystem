...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div style="text-align: center">
        <table style="width: 698px; position: static; height: 100px">
            ...
            <tr>
                <td colspan="6">
                    <asp:DataList ID="DataList1" runat="server" Style="position: static" RepeatColumns="2" RepeatDirection="Horizontal" OnItemCommand="DataList1_ItemCommand" BackColor="White">
                        <ItemTemplate>
                            <table style="width: 382px; position: static; height: 100px">
                                <tr>
                                    ...
                                    <td rowspan="6" style="width: 100px">
                                        <asp:Image ID="Image1" runat="server" BackColor="#99ccff" Height="189px" ImageUrl='<%#Eval("imagepath") %>'
                                            Style="position: static" Width="108px" /></td>
                                </tr>
                                <tr>
                                    <td style="width: 100px">
                                        Item for :</td>
