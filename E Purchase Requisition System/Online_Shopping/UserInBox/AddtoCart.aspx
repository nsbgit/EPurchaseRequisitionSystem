...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None"
        ...
        <ItemTemplate>
        <asp:Image ID="imgpath" runat="server" Width="108px" Height="189px" ImageUrl='<%#Eval("imgpath") %>' />
        </ItemTemplate>
        </asp:TemplateField>
            ...
            <tr>
                <td style="width: 100px">
                    <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" OnClick="LinkButton1_Click"
                        Style="position: static" Width="135px" BackColor="#999999" Font-Underline="True" ForeColor="Black">ORDER&gt;&gt;</asp:LinkButton></td>
                <td style="width: 100px">
                    Total cost:</td>
                <td style="width: 100px">
