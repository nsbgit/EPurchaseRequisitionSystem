    ...
    <div style="text-align: left">
        <table style="width: 511px; position: static; height: 100px">
            ...
            <tr>
                ...
                <td style="width: 100px" bgcolor="White">
                    <asp:Image ID="Image3" runat="server" Height="30px" ImageUrl="~/debitcards/axis bank.jpg"
                        Style="position: static" Width="150px" /></td>
                <td style="width: 100px" bgcolor="White">
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 100px" bgcolor="White">
                    <asp:Image ID="Image4" runat="server" Height="30px" ImageUrl="~/debitcards/hdfc.jpg"
                        Style="position: static" Width="150px" /></td>
                <td style="width: 100px" bgcolor="White">
                </td>
            </tr>
            <tr>
                <td style="width: 100px; height: 22px" bgcolor="White">
                    <asp:RadioButton ID="RadioButton5" runat="server" Style="position: static" GroupName="a" Text="Citi Bank" Width="116px" /></td>
                <td style="width: 100px; height: 22px" bgcolor="White">
                    <asp:Image ID="Image5" runat="server" Height="30px" ImageUrl="~/debitcards/citi-bank-mbaknol.jpg"
                        Style="position: static" Width="150px" /></td>
                <td style="width: 100px; height: 22px" bgcolor="White">
                </td>
            </tr>
