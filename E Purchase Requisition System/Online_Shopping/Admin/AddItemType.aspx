...
<asp:Content ID="c1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="text-align: center">
        <table style="width: 460px; position: static; height: 100px" align="center">
            <tr>
                <td colspan="3">
            ...
            <tr>
                ...
                <td style="width: 100px; height: 19px">
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox1" ErrorMessage="Item type is required" ValidationGroup="grpAdd">*</asp:RequiredFieldValidator>
                </td>
            </tr>
            <tr>
